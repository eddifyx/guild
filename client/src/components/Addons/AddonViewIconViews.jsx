...
export const AddonFileIcon = memo(function AddonFileIcon({ variant = 'file' }) {
...
export const AddonUploadIcon = memo(function AddonUploadIcon() {
  return (
...
export const AddonDownloadIcon = memo(function AddonDownloadIcon() {
  return (
...
export const AddonDeleteIcon = memo(function AddonDeleteIcon() {
  return (
    <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const AddonDropZoneIcon = memo(function AddonDropZoneIcon() {
  return (
...
export const AddonUploadedIcon = memo(function AddonUploadedIcon() {
  return (
